...
public class DSL_SERVER extends ServerSocket {
    ...
    protected static final int SERVER_PORT = 8080; // 服务端端口
    protected static final String USERLOOK = "useronline"; // 查看在线用户

    public static List<String> userList = new CopyOnWriteArrayList<String>(); // CopyOnWriteArrayList is a data
                                                                              // structure created to be used in a
