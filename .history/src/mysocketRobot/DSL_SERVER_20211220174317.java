...
public class DSL_SERVER extends ServerSocket {
    ...
    protected static final String Version = "ServerRobot 1.0";
    /**
    ...
    protected static final String ROBOTVERSION = "robotversion"; // view current version of the server robot

    /**
     * The following interface is not yet implemented!!!!
     */
    protected static final String MSLOOK = "ms"; // view our server's connection state with media server
    protected static final String SIPLOOK = "sip"; // View SIP links between the phone network and SIP message
                                                   // statistics
    protected static final String SALOOK = "sa"; // View the connection with the natural language analysis system,
                                                 // statistics
    ...
    public void load() throws Exception {
        ...
        while (true) {
            ...
            /**
             * The server processes the connection request of the client synchronously.
